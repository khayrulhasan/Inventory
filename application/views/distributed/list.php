<style>
    ...
    <div class="row">
        <span style="margin-left: 20px"><button class="btn btn-info dynamicFormModal" type="button"  data-action="<?php echo base_url() ?>index.php/setup/getFilteringFormForDistributed/<?php echo $id?>"   data-toggle="tooltip"  title="Data Filtering" modal-head="Data Filtering Form"><i class="fa fa-filter"></i></button></span>&nbsp;
        ...
        <a href="<?php echo base_url() ?>index.php/reports/distributedReportPDF/<?php echo $id?>" data-toggle="tooltip"  title="Download PDF Format" target="_blank"><img src="<?php echo base_url()?>uploads/pdf.png" height="40" width="40"></a>&nbsp;
    </div>
    <div class="box">
        <div class="box-body">
