<div class="modal fade" id="myModalAddItem" tabindex="-1" role="dialog" 
    ...
    <div class="modal-dialog">
        <form action="<?php echo base_url() ?>index.php/setup/saveConsumeItem" method="post" class="form-horizontal" role="form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="hidden" name="image_id" value="<?php echo $image_d ?>">
                        ...
                        <div class="col-sm-3">
                            <div class='input-group date' id='datetimepicker1'>
                                <input type="text" class="form-control" name="receive_date" data-toggle="tooltip" value="14/12/16"  title="<?php echo $result->fld_last_receive_date; ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="number" onkeyup="existNumber()" id="num1" value="" name="issue_quantity" required="required" placeholder="Enter Quantity" class="form-control">
                        </div>
                        <div class="col-sm-4">
                            <input type="text" disabled="disabled" value="<?php echo $result->fldUnit ?>" class="form-control">
                        </div>
