...
<div class="row">
    <span style="margin-left: 20px"><button class="btn btn-info dynamicFormModal" type="button"  data-action="<?php echo base_url() ?>index.php/setup/getFilteringFormForEditDistribution"   data-toggle="tooltip"  title="Data Filtering" modal-head="Data Filtering Form"><i class="fa fa-filter"></i></button></span>&nbsp;
    ...
    <a href="<?php echo base_url() ?>index.php/reports/issuedReportPDF" data-toggle="tooltip"  title="Download PDF Format" target="_blank"><img src="<?php echo base_url() ?>uploads/pdf.png" height="40" width="40"></a>&nbsp;
</div>
<div class="box">
    <div class="box-body">
                ...
                foreach ($result as $key => $value) {
                    if ($value->quantity) {
                        ...
                        <tr>
                            ...
                            <td style="width: 60px">
                                <button type="button"  data-action="<?php echo base_url() ?>index.php/setup/getDistributionEditForm/<?php echo $value->id ?>/<?php echo $value->image_id ?>"   data-toggle="tooltip"  title="Edit Distribution" modal-head="Edit Issue This Item" class="dynamicFormModal btn-xs btn-info"><i class="fa fa-arrow-circle-o-right"></i></button>
                            </td>
                        </tr>
                        <?php
                    }
