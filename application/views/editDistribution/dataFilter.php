        ...
        <div class="modal-content">
            ...
            <div class="container-filter">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li class="active"><a data-target="#user" data-toggle="tab">By User Filtering</a></li>
                </ul>
                    ...
                    <div class="tab-pane" id="date">
                        <div class="tab-pane active" id="type">
                            <div class="form-group">
                                <form action="<?php echo base_url() ?>index.php/setup/editIssueItemList" method="post">
                            ...
                            <form action="<?php echo base_url() ?>index.php/setup/editIssueItemList" method="post">
                                <div style="margin-left: -5px;">
                                    <div class="form-group col-sm-4">
                                        ...
                                        <?php echo form_dropdown('user', $user, '', 'class="form-control col-sm-2 mainManu searSelect"'); ?>
                                    </div><br/>
                                    <div class="form-group col-sm-3">
                                        <label for="item">&nbsp;</label>
                                        <input type="submit" class="btn btn-info" style="position: relative;  bottom: -2px" value="Search">
