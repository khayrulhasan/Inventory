...
$(function () {
    ...
    intervals.setOnHandleMouseenterCallback(function (context, period, edgeIndex) {
        ...
        var periodId = period.getId();
        var handleAbscissa = period.getAbscissas()[edgeIndex];
        $("#onhandlemouseenter_info").html("Last OnHandleMouseenter data:" + "<br>" + " --- x-position: " + (handlePosition-236.765625) + " px<br>" + " --- slider value (abscissa): " + handleAbscissa + "<br>" + " --- orientation: " + (edgeIndex === 1 ? "right" : "left") + " handle<br>" + "Period id: " + periodId + "<br>");
    });
